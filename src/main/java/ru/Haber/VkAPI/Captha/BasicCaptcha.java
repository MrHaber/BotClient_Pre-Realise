...
public class BasicCaptcha {
    ...
    public BasicCaptcha(int width, int height) {
...
//        }
    ...
    public void distortionElectric2(double alpha) {
        ...
        dxField = BasicCaptcha.gaussian(dxField, 2, 2.2);
        dyField = BasicCaptcha.gaussian(dyField, 2, 2.2);
...
//                    System.out.println(target);
    ...
    public void distortionElastic(double alpha, int kernelSize, double sigma) {
        ...
        dxField = BasicCaptcha.gaussian(dxField, kernelSize, sigma);
        dyField = BasicCaptcha.gaussian(dyField, kernelSize, sigma);
