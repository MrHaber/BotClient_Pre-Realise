...
public class GoogleTextToSpeech extends BaseSynthsiser{
	/**
	...
	public static final String LANG_RU_RUSSIA = "ru";
	...
	public InputStream getMP3Data(String synthText) throws IOException{
		...
		if(languageCode == null || languageCode.equals("") || languageCode.equalsIgnoreCase("auto")){
			languageCode = GoogleTranslate.detectLanguage(synthText);//Detects language
